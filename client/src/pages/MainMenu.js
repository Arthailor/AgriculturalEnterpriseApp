...
import { ANIMALS_AND_PASTURES_ROUTE, CROPS_AND_FIELDS_ROUTE, EQUIPMENT_AND_REPAIRS_ROUTE, FIELDEQUIPMENT_ROUTE, FIELDJOBS_ROUTE } from '../utils/consts';
        ...
        >
          <Card style={{ width: 600 }} className="p-5">
            ...
            <Form className="d-flex flex-column">
              ...
              <NavLink to={FIELDJOBS_ROUTE} className="mt-3" style={{ textDecoration: 'none' }}>
                <Button className="d-flex justify-content-between" variant={"outline-primary"} style={{ width: "100%" }}>
              ...
              <NavLink to={FIELDEQUIPMENT_ROUTE} className="mt-3" style={{ textDecoration: 'none' }}>
                <Button className="d-flex justify-content-between" variant={"outline-primary"} style={{ width: "100%" }}>
                  <Image width="20" src="./tractor.png" fluid />
                  <div style={{ marginRight: 20 }}>Equipment on fields</div>
                  <div></div>
                </Button>
              </NavLink>
            </Form>
